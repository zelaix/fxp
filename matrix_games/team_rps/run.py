...
from matrix_games.team_rps.game import TeamRPSGame
...
if __name__ == "__main__":
    to_run = ["SP", "FSP", "PSRO_uniform", "PSRO_uniform_meta", "PSRO_uniform_warm", "PSRO_uniform_warm_meta", "FXP", "FXP_c", "FXP_meta"]
    np.random.seed(0)
    ...
    fig.savefig("figs/team_rps_all.png")
