...
def get_config():
    ...
    parser = argparse.ArgumentParser(
        description='fxp', formatter_class=argparse.RawDescriptionHelpFormatter)
    ...
    parser.add_argument("--use_neurd", action="store_true", default=False, help="by default False. If True, use NeuRD.")
