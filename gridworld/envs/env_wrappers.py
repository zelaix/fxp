...
from gridworld.utils.util import tile_images
...
class SubprocVecEnv(ShareVecEnv):
    ...
    def update(self, kwargs_list):
        for remote, kwargs in zip(self.remotes, kwargs_list):
            remote.send(('update', kwargs))
        done = [remote.recv() for remote in self.remotes]
