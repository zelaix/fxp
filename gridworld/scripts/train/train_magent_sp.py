...
def parse_args(args, parser):
    ...
    parser.add_argument("--sp_prob", type=float, default=1.0, help="self play probability, by default 1.")
...
def main(args):
    ...
    if all_args.share_policy:
        from gridworld.runner.shared.magent_sp_runner import MAgentSPRunner as Runner
    else:
        raise NotImplementedError
